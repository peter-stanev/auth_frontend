...
var vendor = {
  ...
  base: {
    source: require('./app/vendor.base.json'),
    dest: 'public/js',
    name: 'base.js'
  },
...
var injectOptions = {
    ...
    transform: function (filepath) {
        return 'script(src=\'' +
            filepath.substr(filepath.indexOf('public')) +
            '\')';
    }
}
...
// VENDOR BUILD
gulp.task('vendor', gulpsync.sync(['vendor:base', 'vendor:public']));
...
gulp.task('vendor:public', function () {
