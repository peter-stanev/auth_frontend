    ...
    function routesConfig($stateProvider, $locationProvider, $urlRouterProvider, helper) {
        ...
        $stateProvider
            ...
            .state('app.edit-profile', {
                ...
                templateUrl: helper.basepath('edit-profile.html'),
                resolve: helper.resolveFor('flot-chart', 'flot-chart-plugins', 'vector-map', 'vector-map-maps')
            })
            .state('app.village', {
                url: '/village',
                ...
                templateUrl: helper.basepath('village.html')
            })
            .state('app.invite-villagers', {
                url: '/invite-villagers',
                title: 'Invite Villagers',
                controller: 'InviteVillagersController',
                controllerAs: 'invite-villagers',
                templateUrl: helper.basepath('invite-villagers.html')
            })
            .state('app.requests', {
                url: '/requests',
                title: 'Requests',
                ...
                templateUrl: helper.basepath('requests.html')
            })
            .state('app.offers', {
                url: '/offers',
                title: 'Offers',
                ...
                controllerAs: 'offers',
                templateUrl: helper.basepath('offers.html')
            })
            .state('app.history', {
                url: '/history',
                title: 'History',
            ...
            .state('app.badges', {
                ...
                controllerAs: 'badges',
                templateUrl: helper.basepath('badges.html')
            })
            .state('app.settings', {
                url: '/settings',
                title: 'Settings',
